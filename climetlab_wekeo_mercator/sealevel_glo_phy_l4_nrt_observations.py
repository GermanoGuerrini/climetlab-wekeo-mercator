...
LAYERS = [
    "dataset-duacs-nrt-global-merged-allsat-phy-l4_202112",  # NRT merged all satellites global ocean gridded ssalto/duacs sea surface height l4 product and derived variables
]
