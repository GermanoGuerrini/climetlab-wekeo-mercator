...
LAYERS = [
    "dataset-duacs-nrt-europe-h2b-phy-l3_202007",  # dataset-duacs-nrt-europe-h2b-phy-l3_202007
    "cmems_obs-sl_eur_phy-ssh_nrt_s3a-l3-duacs_PT0.2S_202211",  # cmems_obs-sl_eur_phy-ssh_nrt_s3a-l3-duacs_PT0.2S_202211
    "cmems_obs-sl_eur_phy-ssh_nrt_s3b-l3-duacs_PT0.2S_202211",  # cmems_obs-sl_eur_phy-ssh_nrt_s3b-l3-duacs_PT0.2S_202211
    "dataset-duacs-nrt-europe-c2-phy-l3_202003",  # dataset-duacs-nrt-europe-c2-phy-l3_202003
    "dataset-duacs-nrt-europe-s3b-phy-l3_202003",  # dataset-duacs-nrt-europe-s3b-phy-l3_202003
    "dataset-duacs-nrt-europe-c2n-phy-l3_202010",  # dataset-duacs-nrt-europe-c2n-phy-l3_202010
    "cmems_obs-sl_eur_phy-ssh_nrt_j3n-l3-duacs_PT1S_202207",  # cmems_obs-sl_eur_phy-ssh_nrt_j3n-l3-duacs_PT1S_202207
    "cmems_obs-sl_eur_phy-ssh_nrt_s6a-hr-l3-duacs_PT0.2S_202211",  # cmems_obs-sl_eur_phy-ssh_nrt_s6a-hr-l3-duacs_PT0.2S_202211
    "cmems_obs-sl_eur_phy-ssh_nrt_j3n-l3-duacs_PT0.2S_202211",  # cmems_obs-sl_eur_phy-ssh_nrt_j3n-l3-duacs_PT0.2S_202211
    "dataset-duacs-nrt-europe-s3a-phy-l3_202003",  # dataset-duacs-nrt-europe-s3a-phy-l3_202003
    "cmems_obs-sl_eur_phy-ssh_nrt_h2c-l3-duacs_PT0.2S_202211",  # cmems_obs-sl_eur_phy-ssh_nrt_h2c-l3-duacs_PT0.2S_202211
    "dataset-duacs-nrt-europe-j3-phy-l3_202003",  # dataset-duacs-nrt-europe-j3-phy-l3_202003
    "dataset-duacs-nrt-europe-al-phy-l3_202003",  # dataset-duacs-nrt-europe-al-phy-l3_202003
    "cmems_obs-sl_eur_phy-ssh_nrt_h2b-l3-duacs_PT0.2S_202211",  # cmems_obs-sl_eur_phy-ssh_nrt_h2b-l3-duacs_PT0.2S_202211
    "cmems_obs-sl_eur_phy-ssh_nrt_s6a-hr-l3-duacs_PT1S_202112",  # cmems_obs-sl_eur_phy-ssh_nrt_s6a-hr-l3-duacs_PT1S_202112
]
