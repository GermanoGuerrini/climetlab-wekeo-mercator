...
LAYERS = [
    "cmems_obs-sst_bs_phy_my_l3s_P1D-m_202211",  # Black sea sst, l3s, reprocessed using esa cci sst v.2.0, c3s v.2.0, c3s v.2.1 l3c product and pfv53 data, 0.05 deg. daily (sst bs phy l3s my 010 041)
]
