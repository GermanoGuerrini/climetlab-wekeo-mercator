...
LAYERS = [
    "CERSAT-GLO-SEAICE_3DAYS_DRIFT_ASCAT_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 3day drift, ascat
    "CERSAT-GLO-SEAICE_3DAYS_DRIFT_QUICKSCAT_SSMI_MERGED_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 3day drift, quikscat
    "cmems_obs-si_arc_phy_my_drift-amsr_P6D_202012",  # Arctic ocean - sea ice - 6 days drift, amsr
    "CERSAT-GLO-SEAICE_6DAYS_DRIFT_QUICKSCAT_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 6 days drift, quikscat
    "cmems_obs-si_arc_phy_my_drift-amsr_P2D_202012",  # Arctic ocean - sea ice - 2 days drift, amsr
    "cmems_obs-si_arc_phy_my_drift-amsr_P3D_202012",  # Arctic ocean - sea ice - 3 days drift, amsr
    "CERSAT-GLO-SEAICE_30DAYS_DRIFT_ASCAT_SSMI_MERGED_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 30day drift, ascat-ssm/i
    "CERSAT-GLO-SEAICE_3DAYS_DRIFT_ASCAT_SSMI_MERGED_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 3day drift, ascat-ssm/i
    "CERSAT-GLO-SEAICE_30DAYS_DRIFT_QUICKSCAT_SSMI_MERGED_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 30day drift, quikscat-ssm/i
    "CERSAT-GLO-SEAICE_3DAYS_DRIFT_QUICKSCAT_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 3day drift, quikscat
    "CERSAT-GLO-SEAICE_6DAYS_DRIFT_ASCAT_RAN-OBS_FULL_TIME_SERIE",  # Arctic ocean - sea ice - 6 days drift, ascat
]
