...
LAYERS = [
    "cmems_obs-wave_glo_phy-swh_nrt_multi-l4-2deg_P1D_202211",  # NRT merged all satellites global ocean gridded significant wave height l4 product and derived variables
]
